# GPT Image 2.5 API (gpt-image-2.5 / gptimage2.5) — api guide with published pricing
...
**[Live pricing](https://go.apimart.ai/k-629b8c)** · **[Get an API key](https://go.apimart.ai/k-490cd1)**
